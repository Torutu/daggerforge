...
const TOOLTIP_LINES = [
	"Dice: typing '1d6', '2d8+3', etc. become clickable roll buttons when the card is inserted.",
	"Keywords: typing 'hope', 'fear', 'hp', 'stress' (any casing) are auto-colored when keyword highlighting is enabled in Settings.",
];
