...
export class AdversaryEditor {
    static open(plugin: DaggerForgePlugin, editor: Editor, cardElement: HTMLElement) {
        try {
            ...
            new Notice('Failed to edit adversary. Please check console for details.');
